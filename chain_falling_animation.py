...
starting_height = 2 #starting height of the lowest ball
...
while (current_time <= total_time):
	...
	plot(zeros(n), current_position, 'ro',
		[-0.004,0.004], [0,0], '-b',
		[-0.004,0.004], [15,15], '-w'
		) #the top line is for preventing autoscale

	title("time={:4.2f}".format(current_time))
	draw()
	pause(0.001)
